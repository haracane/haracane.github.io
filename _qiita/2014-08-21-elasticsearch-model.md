...
※ この記事は[江の島エンジニアBlog](http://blog.enogineer.com/)の「[elasticsearch-rails0.1.4を使ってRails4.1.5でN-gram検索する](http://blog.enogineer.com/2014/08/21/elasticsearch-model/)」の転載です。
