...
※ この記事は[江の島エンジニアBlog](http://blog.enogineer.com/)の「[curlコマンドでNginxのX-Forwarded-ProtoでのHTTPSリダイレクトのテストをする](http://blog.enogineer.com/2015/01/20/curl-nginx-https-redirect/)」の転載です。
