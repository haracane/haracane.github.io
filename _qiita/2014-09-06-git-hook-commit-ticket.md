...
※ この記事は[江の島エンジニアBlog](http://blog.enogineer.com/)の「[git commitをフックしてコミットメッセージに自動的にチケット番号を追加する](http://blog.enogineer.com/2014/09/06/git-hook-commit-ticket/)」の転載です。
