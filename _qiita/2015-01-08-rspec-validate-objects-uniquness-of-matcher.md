...
※ この記事は[江の島エンジニアBlog](http://blog.enogineer.com/)の「[has-many関連のuniqueness validationをテストするカスタムマッチャも作ってみた](http://blog.enogineer.com/2015/01/08/rspec-validate-objects-uniquness-of-matcher/)」の転載です。
